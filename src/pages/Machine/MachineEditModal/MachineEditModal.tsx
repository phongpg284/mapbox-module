...
const MachineEditModal: React.FC<IMachineEditModal> = ({ id, onClose, visible, update, ...props }) => {
    ...
    return (
        <div className={style.machine_edit_container}>
            <AddModal {...props} visible={visible} onCancel={onClose} title={`Cập nhật máy ${data?.name}`} footer={<Button onClick={handleSubmitEdit}>Cập nhật</Button>}>
                <div className={style.machine_edit_content}>
                    ...
                    {data && (
                        <Form form={form} layout="vertical" onFinish={onFinish} onFinishFailed={onFinishFailed} autoComplete="off">
                            ...
                            <div style={{ overflow: 'hidden' }}>
                                <Form.Item name="model" label="Kiểu xe">
                                    <Input placeholder="" />
                                </Form.Item>
                            </div>
                            <div style={{ overflow: 'hidden' }}>
