...
const UserEdit: React.FC<IUserEdit> = ({ match }: any) => {
    ...
    return (
        <div className={style.user_edit_container}>
            <div className={style.user_edit_title}>Cập nhật thông tin</div>
            <div className={style.user_edit_avatar}>
                <img src="https://www.sibberhuuske.nl/wp-content/uploads/2016/10/default-avatar.png" alt="avatar" />
            </div>
            <div>
                <div className={style.user_edit_content}>
                    {isFetching && <Spin />}
                    {data && (
